...
public class MovieService {
    ...
    public ResponseEntity<MovieDto> findMovie(final String movieTitle) {
        ...
        final ResponseEntity<MovieDto> response = restTemplate.getForEntity(movieDataFinderUrlGenerator.generateUrl(movieTitle), MovieDto.class);
        final MovieDto movieDto = response.getBody();
